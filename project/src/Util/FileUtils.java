 ...
 * <a href="http://www.gnu.org/licenses/lgpl.txt" title="http://www.gnu.org/licenses/lgpl.txt">http://www.gnu.org/licenses/lgpl.txt</a>
 *
 */
public class FileUtils
{
     ...
     * Strings.
     */
    public static ArrayList<String> readFileAsListOfStrings(String filename) throws Exception
    {
    ...
    /**
     * Write and object to file. Presumably this is binary data; for plain text
     * use the writeFile method.
     */
    public static void writeFileAsObject(String canonicalFilename, Object obj) throws IOException
    {
        FileOutputStream fos = new FileOutputStream(canonicalFilename);
     ...
     * use the writeFile method.
     */
    public static List readFileAsObject(String fileName, Object obj) throws IOException, ClassNotFoundException {
